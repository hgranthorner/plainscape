...
void
create_vertex_array_and_buffers(unsigned int &vertex_array, unsigned int &vertex_buffer, unsigned int &index_buffer) {
	vertex_array = 0;
...
void bind_and_load_index_buffer(unsigned int index_buffer_id, const std::vector<unsigned int> &indices) {
...
VertexArray::VertexArray(const std::vector<glm::vec3> &vertices, const std::vector<unsigned int> &indices) {
